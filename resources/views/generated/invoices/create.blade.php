...
<div class="bg-white border border-stone-200 rounded-1xl overflow-hidden">
    <div class="px-6 py-5 border-b border-stone-100 flex items-center justify-between">
        <div>
            <h3 class="text-sm font-semibold text-stone-800">New Invoice</h3>
    ...
    <form method="POST" action="{{ route('generated.invoices.store') }}" enctype="multipart/form-data">
        @csrf 
        <div class="p-6">
            @if($errors->any())
            ...
            <div class="grid grid-cols-3 gap-5">
                <div class="col-span-1">
                    ...
                    <input type="text" name="invoice_no" value="{{ old('invoice_no') }}" placeholder="INV-001" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('invoice_no') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="date" name="invoice_date" value="{{ old('invoice_date') ?? date('Y-m-d') }}" placeholder="Invoice Date" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('invoice_date') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="purchase_order_no" value="{{ old('purchase_order_no') }}" placeholder="PO-001" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('purchase_order_no') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="date" name="purchase_order_date" value="{{ old('purchase_order_date') }}" placeholder="Purchase Order Date" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('purchase_order_date') border-red-400 bg-red-50 @enderror">
                    ...
                    <select name="buyer" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('buyer') border-red-400 bg-red-50 @enderror"><option value="">-- Select --</option>
                        @isset($buyer_options)
                            @foreach($buyer_options as $val => $lab)
                                <option value="{{ $val }}" {{ (old('buyer') ?? '') == $val ? 'selected' : '' }}>{{ $lab }}</option>
                            @endforeach
                        @endisset
</select>
                    ...
                    <select name="vendor" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('vendor') border-red-400 bg-red-50 @enderror"><option value="">-- Select --</option>
                        @isset($vendor_options)
                            @foreach($vendor_options as $val => $lab)
                                <option value="{{ $val }}" {{ (old('vendor') ?? '') == $val ? 'selected' : '' }}>{{ $lab }}</option>
                            @endforeach
                        @endisset
</select>
                ...
                <div class="col-span-1">
                    ...
                    <textarea name="buyer_address" rows="4" placeholder="Address" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('buyer_address') border-red-400 bg-red-50 @enderror resize-none">{{ old('buyer_address') }}</textarea>
                ...
                <div class="col-span-1">
                    ...
                    <textarea name="vendor_address" rows="4" placeholder="Address" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('vendor_address') border-red-400 bg-red-50 @enderror resize-none">{{ old('vendor_address') }}</textarea>
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="dispatch_through" value="{{ old('dispatch_through') }}" placeholder="Transport name" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('dispatch_through') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="date" name="dispatch_date" value="{{ old('dispatch_date') }}" placeholder="Dispatch Date" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('dispatch_date') border-red-400 bg-red-50 @enderror">
...
@if(isset($invoice) && $invoice->line_items->count())
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="subtotal" value="{{ old('subtotal') }}" placeholder="Total" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('subtotal') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="round_off" value="{{ old('round_off') }}" placeholder="Round Off" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('round_off') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="grand_total" value="{{ old('grand_total') }}" placeholder="Grand Total" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('grand_total') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-3">
                    ...
                    <input type="text" name="invoice_summary" value="{{ old('invoice_summary') }}" placeholder="Invoice Summary" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('invoice_summary') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-3">
                    ...
                    <textarea name="remark" rows="4" placeholder="Enter remarks..." class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('remark') border-red-400 bg-red-50 @enderror resize-none">{{ old('remark') }}</textarea>
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="auto_approve" value="{{ old('auto_approve') }}" placeholder="Auto Approve" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('auto_approve') border-red-400 bg-red-50 @enderror">
