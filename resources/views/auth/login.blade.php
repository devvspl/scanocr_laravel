...
<div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
    ...
    <!-- Token login error / general errors -->
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-red-800 dark:text-red-300">
                        {{ $errors->first('token') ?? session('error') }}
                    </p>
                </div>
            </div>
        </div>
            ...
            <div x-data="{ showPassword: false }">
                ...
                <div class="mt-2 relative">
                    <input id="password" name="password" :type="showPassword ? 'text' : 'password'" autocomplete="current-password" required
                        class="appearance-none block w-full px-3 py-2 pr-10 text-sm border @error('password') border-red-300 text-red-900 placeholder-red-300 focus:ring-red-900 focus:border-red-900 @else border-stone-300 dark:border-stone-700 focus:ring-red-900 focus:border-red-900 dark:bg-stone-950/50 dark:text-white @enderror rounded-lg shadow-sm placeholder-stone-400 focus:outline-none focus:ring-2 transition-all duration-200">
                    <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 pr-3 flex items-center text-stone-400 hover:text-stone-600 dark:hover:text-stone-300 transition-colors">
                        <!-- Eye Icon (Show) -->
