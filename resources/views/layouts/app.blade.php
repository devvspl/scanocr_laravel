            ...
            @php
                ...
                $railItems = [
                    ...
                    [
                        ...
                        'route' => 'workflow.punch-approval.index',
                        'role'  => 'Punch Approval',
                    ...
                    [
                        ...
                        'children' => [
                            ...
                            ['section' => 'Master Data'],
                            ['label' => 'Work Locations',  'route' => 'settings.work-locations',   'permission' => 'work-locations.view'],
                            ['label' => 'Ledgers',         'route' => 'settings.ledgers',          'permission' => 'ledgers.view'],
                            ['label' => 'Firms',           'route' => 'settings.firms',            'permission' => 'firms.view'],
                            ['label' => 'Departments',     'route' => 'settings.departments',      'permission' => 'departments.view'],
                            ['label' => 'Files',           'route' => 'settings.files',            'permission' => 'files.view'],
                            ['label' => 'Units',           'route' => 'settings.units',            'permission' => 'units.view'],
                            ['label' => 'Hotels',          'route' => 'settings.hotels',           'permission' => 'hotels.view'],
                            ['label' => 'Items',           'route' => 'settings.items',            'permission' => 'items.view'],
                            ['section' => 'Ext Master'],
