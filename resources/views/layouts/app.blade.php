        ...
        <header id="topbar" x-data="{ mobileSearch: false }">
            ...
            <div class="flex items-center gap-1.5 shrink-0">
                ...
                @php
                    ...
                    $__currentFy = $__currentCompany ? \App\Models\FinancialYear::where('company_id', $__currentCompany->id)->where('is_current', true)->first() : null;
                    $__companies = \App\Models\Company::where('is_active', true)->orderBy('name')->get(['id', 'name', 'is_default']);
                    $__fys = $__currentCompany ? \App\Models\FinancialYear::where('company_id', $__currentCompany->id)->orderByDesc('start_date')->get(['id', 'label', 'is_current']) : collect();
                @endphp
