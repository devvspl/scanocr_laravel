...
@section('content')
<div class="mx-auto space-y-4" x-data="productPage()" x-init="init()">
    ...
    @include('panel.items._product-list', [
        'dataRoute' => route('master.products.data'),
        'groups'    => $groups,
        'units'     => $units,
    ])
...
@include('panel.items._product-scripts', ['dataRoute' => route('master.products.data')])
