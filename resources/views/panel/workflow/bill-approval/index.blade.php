...
async function openDetailModal(scanId){
    try{
        ...
        if(d.Bill_Approved==='Y') info+=`<div class="info-row"><span class="info-label">Status</span><span class="info-value"><span class="badge-approved">Approved</span></span></div>`;
        else if(d.Bill_Approved==='R') info+=`<div class="info-row"><span class="info-label">Status</span><span class="info-value"><span class="badge-rejected">Rejected</span></span></div><div class="info-row"><span class="info-label">Remark</span><span class="info-value text-red-700 text-[11px]">${esc(d.Bill_Approver_Remark||'—')}</span></div>`;
