...
<div class="f-row cols-2">
    <div class="f-group">
        <label>Credit Note No <span style="color:#dc2626">*</span></label>
        <input type="text" name="CreditNo" class="f-input" required value="{{ $punchDetail->CreditNo ?? '' }}">
    </div>
    <div class="f-group">
        <label>Credit Note Date <span style="color:#dc2626">*</span></label>
        <input type="date" name="CreditDate" class="f-input" required value="{{ $punchDetail->CreditDate ?? '' }}">
    </div>
</div>
...
<div class="f-row cols-2">
    <div class="f-group">
        <label>Vendor (From) <span style="color:#dc2626">*</span></label>
    ...
    <div class="f-group">
        <label>Buyer (To) <span style="color:#dc2626">*</span></label>
...
<div class="f-row">
    ...
    <div class="f-group">
        ...
        <input type="text" name="Dispatch_Trough" class="f-input" value="{{ $punchDetail->Particular ?? '' }}">
    </div>
    <div class="f-group">
...
<div class="f-row">
    <div class="f-group">
        ...
        <select name="Location" id="selLocation" style="width:100%" required>
...
{{-- Line Items --}}
<div style="margin:.6rem 0 .5rem"><span style="font-size:.65rem;font-weight:700;color:#7f1d1d;text-transform:uppercase;letter-spacing:.03em">Line Items <span style="color:#dc2626">*</span></span></div>
    ...
    <table class="items-table">
        <thead>
            <tr>
                ...
                <th style="width:180px">Particular <span style="color:#dc2626">*</span></th>
                <th style="width:70px">HSN</th>
                <th style="width:55px">Qty <span style="color:#dc2626">*</span></th>
                <th style="width:70px">Unit</th>
                <th style="width:70px">MRP <span style="color:#dc2626">*</span></th>
        ...
        <tbody id="itemsBody">
            <tr>
                <td>1</td>
                <td><select name="Particular[]" class="particular-sel" style="width:100%" required><option value="">Select</option></select></td>
                <td><input type="text" name="HSN[]"></td>
                <td><input type="text" name="Qty[]" class="calc-trigger" inputmode="decimal" required></td>
                <td><select name="Unit[]" class="unit-sel"></select></td>
                <td><input type="text" name="MRP[]" class="calc-trigger" inputmode="decimal" required></td>
...
<div class="f-row" style="display:flex;flex-wrap:nowrap;gap:.4rem">
    ...
    <div class="f-group" style="flex:1.3;min-width:140px">
        ...
        <div style="display:flex;border:1px solid #d6d3d1;border-radius:.5rem;overflow:hidden;height:24px;background:#fafaf9">
            ...
            <input type="text" name="Round_Off_Value" id="creditNoteRoundOff" style="flex:1;border:none;outline:none;background:transparent;font-size:.7rem;padding:0 .4rem;min-width:0" readonly>
        </div>
    </div>
    <div class="f-group" style="flex:1;min-width:100px">
        <label>Total</label>
    ...
    <div class="f-group" style="flex:1;min-width:100px">
        ...
        <input type="text" name="Grand_Total" id="grandTotal" class="f-input" readonly required value="{{ $punchDetail->Grand_Total ?? '' }}">
    </div>
</div>
