{{-- Template 1: Classic Professional — clean white, thin borders, formal layout --}}
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
.co-name { font-size:18px; font-weight:bold; color:#1c1917; margin-bottom:2px; }
.co-legal { font-size:10px; color:#78716c; margin-bottom:3px; }
.co-addr  { font-size:10px; color:#57534e; line-height:1.6; }
.co-gstin { font-size:9.5px; color:#78716c; margin-top:4px; font-family:DejaVu Sans Mono,monospace; }
.inv-title { font-size:28px; font-weight:bold; color:#1c1917; letter-spacing:2px; text-transform:uppercase; }
.inv-num   { font-size:11px; color:#57534e; margin-top:5px; font-family:DejaVu Sans Mono,monospace; }

/* Dividers */
.rule-thick { border:none; border-top:2px solid #292524; margin:14px 0 10px; }
.rule-thin  { border:none; border-top:1px solid #e7e5e4; margin:10px 0; }

/* Bill-to / meta */
.meta-grid { display:table; width:100%; margin-bottom:14px; }
.meta-cell { display:table-cell; vertical-align:top; padding-right:12px; }
.meta-lbl  { font-size:9px; font-weight:bold; color:#78716c; text-transform:uppercase; letter-spacing:1px; margin-bottom:3px; }
...
.tbl thead tr { border-bottom:2px solid #292524; }
.tbl th { padding:8px 5px; font-size:9px; font-weight:bold; color:#1c1917; text-transform:uppercase; letter-spacing:0.5px; background:#fff; }
...
/* Bottom */
.bot { display:table; width:100%; border-top:2px solid #292524; margin-top:0; }
...
.note-lbl { font-size:9px; font-weight:bold; color:#78716c; text-transform:uppercase; letter-spacing:1px; margin-bottom:3px; }
...
.tot-r-red { color:#b91c1c; }
.tot-r-grn { color:#15803d; }
.grand-sep { border:none; border-top:2px solid #292524; margin:6px 0; }
.grand-row { display:table; width:100%; }
.grand-l { display:table-cell; font-size:13px; font-weight:bold; color:#1c1917; }
.grand-r { display:table-cell; font-size:15px; font-weight:bold; color:#1c1917; text-align:right; }

/* Footer */
.footer { display:table; width:100%; margin-top:20px; border-top:1px solid #e7e5e4; padding-top:8px; }
...
.sig-line { border-top:1px solid #292524; margin-top:36px; padding-top:4px; font-size:9px; color:#57534e; }

/* Status */
.badge { display:inline-block; padding:3px 10px; border-radius:2px; font-size:9px; font-weight:bold; text-transform:uppercase; letter-spacing:0.5px; margin-top:6px; border:1px solid #d6d3d1; color:#57534e; }
</style>
</head>
<body>
<div class="page">
  ...
  <div style="margin-bottom:10px;font-size:10px;color:#57534e;">
  ...
  <div class="bot">
    ...
    <div class="bot-totals">
      ...
      @endphp
      @if($advanceAmt > 0)
      <div class="tot-row" style="margin-top:4px;"><div class="tot-l">Advance Payment</div><div class="tot-r" style="color:#1e40af;">− &#8377; {{ number_format($advanceAmt,2) }}</div></div>
      @endif
      @if($additionalPaid > 0)
