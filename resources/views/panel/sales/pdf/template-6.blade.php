{{-- Template 6: Bold Red — white base, thin red accent lines, split header layout --}}
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
/* Top red accent */
.accent-top { border-top:4px solid #dc2626; }

.inner { padding:26px 32px; }

/* Split header */
.hdr-wrap { display:table; width:100%; margin-bottom:18px; }
.hdr-left {
...
.co-addr  { font-size:10px; color:#57534e; line-height:1.6; margin-top:5px; }
.co-gstin { font-size:9.5px; color:#78716c; margin-top:4px; font-family:DejaVu Sans Mono,monospace; }
.inv-title { font-size:28px; font-weight:bold; color:#dc2626; letter-spacing:2px; text-transform:uppercase; }
.inv-num   { font-size:11px; color:#57534e; margin-top:4px; font-family:DejaVu Sans Mono,monospace; }
.inv-date  { font-size:10px; color:#78716c; margin-top:2px; }

/* Badge */
.badge { display:inline-block; padding:3px 10px; border-radius:2px; font-size:9px; font-weight:bold; text-transform:uppercase; letter-spacing:0.5px; margin-top:5px; border:1px solid #d6d3d1; color:#57534e; }

/* Rules */
.rule-red { border:none; border-top:2px solid #dc2626; margin:12px 0; }
.rule     { border:none; border-top:1px solid #f5f5f4; margin:10px 0; }

/* Meta */
.meta-grid { display:table; width:100%; margin-bottom:14px; }
.meta-cell { display:table-cell; vertical-align:top; padding-right:12px; }
.meta-lbl  { font-size:9px; font-weight:bold; color:#dc2626; text-transform:uppercase; letter-spacing:1px; margin-bottom:3px; }
...
.tbl thead tr { border-bottom:2px solid #dc2626; }
.tbl th { padding:8px 5px; font-size:9px; font-weight:bold; color:#dc2626; text-transform:uppercase; letter-spacing:0.5px; background:#fff; }
...
.tbl tbody tr:nth-child(even) td { background:#fefefe; }
.desc-main { font-weight:bold; font-size:11px; }
.desc-sub  { font-size:9.5px; color:#a8a29e; margin-top:1px; }

/* Bottom */
.bot { display:table; width:100%; border-top:2px solid #dc2626; }
.bot-notes  { display:table-cell; width:55%; vertical-align:top; padding:14px 16px 14px 0; }
.bot-totals { display:table-cell; width:45%; vertical-align:bottom; padding:14px 0 14px 16px; border-left:1px solid #fecaca; }
.note-lbl { font-size:9px; font-weight:bold; color:#dc2626; text-transform:uppercase; letter-spacing:1px; margin-bottom:3px; }
...
.grand-sep { border:none; border-top:2px solid #dc2626; margin:6px 0; }
.grand-row { display:table; width:100%; }
.grand-l { display:table-cell; font-size:13px; font-weight:bold; color:#dc2626; }
.grand-r { display:table-cell; font-size:15px; font-weight:bold; color:#1c1917; text-align:right; }

/* Footer */
.footer { display:table; width:100%; margin-top:18px; padding-top:8px; border-top:1px solid #f5f5f4; }
...
.sig-line { border-top:1px solid #dc2626; margin-top:36px; padding-top:4px; font-size:9px; color:#57534e; }
</style>
</head>
<body>
<div class="page">
  ...
  <div class="inner">
    ...
    <div style="margin-bottom:10px;font-size:10px;color:#57534e;"><strong>Place of Supply:</strong> {{ $invoice->place_of_supply }}</div>
    @endif
