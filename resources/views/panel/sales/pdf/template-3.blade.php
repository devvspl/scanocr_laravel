{{-- Template 3: Elegant Gold — white base, refined amber/gold thin accents --}}
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
.accent-top { border-top:3px solid #b45309; border-bottom:1px solid #d97706; height:6px; }

.inner { padding:26px 34px; }
...
.co-legal { font-size:10px; color:#78716c; margin-top:2px; }
...
.inv-title { font-size:28px; font-weight:bold; color:#b45309; letter-spacing:3px; text-transform:uppercase; }
...
/* Rules */
.rule-gold { border:none; border-top:2px solid #b45309; margin:12px 0; }
...
.meta-lbl  { font-size:9px; font-weight:bold; color:#b45309; text-transform:uppercase; letter-spacing:1px; margin-bottom:3px; }
...
.tbl thead tr { border-bottom:2px solid #b45309; }
.tbl th { padding:8px 5px; font-size:9px; font-weight:bold; color:#b45309; text-transform:uppercase; letter-spacing:0.5px; background:#fff; }
...
.tbl tbody tr:nth-child(even) td { background:#fffbeb; }
.desc-main { font-weight:bold; font-size:11px; }
.desc-sub  { font-size:9.5px; color:#a8a29e; margin-top:1px; }

/* Bottom */
.bot { display:table; width:100%; border-top:2px solid #b45309; }
...
.note-lbl { font-size:9px; font-weight:bold; color:#b45309; text-transform:uppercase; letter-spacing:1px; margin-bottom:3px; }
...
.grand-sep { border:none; border-top:2px solid #b45309; margin:6px 0; }
.grand-row { display:table; width:100%; }
.grand-l { display:table-cell; font-size:13px; font-weight:bold; color:#b45309; }
...
.sig-line { border-top:1px solid #b45309; margin-top:36px; padding-top:4px; font-size:9px; color:#57534e; }
</style>
</head>
<body>
<div class="page">
