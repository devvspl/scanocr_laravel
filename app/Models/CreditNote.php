...
{
    protected $fillable = [
        'company_id', 'financial_year_id', 'credit_note_number', 'credit_note_date',
        'party_id', 'billing_address',
        'sale_invoice_id', 'reference_number', 'place_of_supply',
    ...
    public function reasonLabel(): string
    {
        return match ($this->reason) {
            ...
            'deficiency'    => 'Goods/Service Deficiency',
            'other'         => 'Other',
    ...
    public static function generateNumber(int $companyId): string
    {
        ...
        if (!$setting) {
            return 'CN/' . now()->format('Y') . '/' . str_pad(1, 4, '0', STR_PAD_LEFT);
        }
