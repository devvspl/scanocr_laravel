...
class CustomerController extends Controller
{
    public function index()
    {
        ...
        return view('panel.parties.customers', compact('groups'));
    }

    public function data(Request $request)
    {
        $query = Party::customers()->with('group', 'creator');
    ...
    {
        return response()->json($this->row($customer));
    }
    ...
    public function update(Request $request, Party $customer)
    {
        ...
        ActivityLogger::log('updated', $customer, $old, $customer->getAttributes());
    ...
    public function destroy(Party $customer)
    {
        ...
        $customer->delete();
        ActivityLogger::log('deleted', $customer, $snapshot, null);
