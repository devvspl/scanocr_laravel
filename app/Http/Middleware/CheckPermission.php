...
class CheckPermission
{
    private const ALWAYS_ALLOW = [
        ...
        // Master Tables — CRUD operations (temporarily allow all, remove after adding permissions)
        'settings.work-locations',
        'settings.work-locations.data',
        'settings.work-locations.store',
        'settings.work-locations.show',
        'settings.work-locations.update',
        'settings.work-locations.destroy',
        'settings.ledgers',
        'settings.ledgers.data',
        'settings.ledgers.store',
        'settings.ledgers.show',
        'settings.ledgers.update',
        'settings.ledgers.destroy',
        'settings.firms',
        'settings.firms.data',
        'settings.firms.store',
        'settings.firms.show',
        'settings.firms.update',
        'settings.firms.destroy',
        ...
        'settings.files.destroy',
        'settings.units',
        'settings.units.data',
        'settings.units.store',
        'settings.units.show',
        'settings.units.update',
        'settings.units.destroy',
        'settings.hotels',
        'settings.hotels.data',
        'settings.hotels.store',
        'settings.hotels.show',
        'settings.hotels.update',
        'settings.hotels.destroy',
        'settings.items',
        'settings.items.data',
        'settings.items.store',
        'settings.items.show',
